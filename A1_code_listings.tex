...
\begin{itemize}
    ...
    \ldots), tensor-network types such as \jlinline{MPS}, \jlinline{MPO},
    and \jlinline{OpSum}, and re-exported ITensorMPS inspection routines
    such as \jlinline{siteinds}, \jlinline{linkinds}, and \jlinline{inner}.
