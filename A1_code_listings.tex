...
Printed program output is shown in a matching gray box with a
\textbf{Terminal} badge; that text is not syntax-highlighted.
...
\begin{itemize}
    ...
    \jlinline{tester}, \ldots), tensor-network types such as \jlinline{MPS},
    \jlinline{MPO}, and \jlinline{OpSum}, and re-exported ITensorMPS inspection
    routines such as \jlinline{siteinds}, \jlinline{linkinds}, and
    \jlinline{inner}.
    ...
    (\jlinline{Index}, \jlinline{ITensor}, \jlinline{dag}, \jlinline{prime},
    \jlinline{delta}, \jlinline{op}, \jlinline{apply}, \ldots).
    \item \textbf{Orange, bold:} package types and backends such as
    \jlinline{Hilbert}, \jlinline{Liouville}, \jlinline{Dense},
    \jlinline{ACE}, \jlinline{InstrumentSeq}, and \jlinline{TesterSeq}.
