...
The process tensor provides precisely such a description~\cite{Pollock2018Framework,Milz2021}. For a sequence of interventions
...
Then enters the hero of this paper, ProcessTensors.jl. BA BA BAA BAAMMMMMM. We are so cool and easy to use. We also have a lot of documentation and examples. Someone just after learning basic Julia and reading this paper, can already install and use our software to fiddle with process tensors. We are the best. 