...
Sequential construction and divide-and-conquer construction provide different ways of assembling and compressing this network, with the latter exploiting repeated structure to reduce the construction effort~\cite{cygorek2024sublinear}.
...
\texttt{UniformTEMPO.jl} supplies the uniform construction for infinite process tensors~\cite{Link2024Infinite,UniformTEMPOSoftware}, while \texttt{GTEMPO.jl} implements Grassmann influence-functional methods for fermionic impurity problems~\cite{Chen2024GTEMPO,GTEMPOSoftware}.
